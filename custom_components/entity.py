"""entity sensor platform for Ecovacs."""
...
class EcovacsEntity(CoordinatorEntity):
    """Ecovacs entity class."""
    ...
    def __init__(self, coordinator, config_entry, sensor_instance, entity_format) -> None:
        ...
        self.entity_id = async_generate_entity_id(
            entity_format,
            f"{self.device.get_device_name()}_{self.sensor_instance.get_name()}",
    ...
    def name(self):
        ...
        return f"{self.device.get_device_name()} {self.sensor_instance.get_description()}"
